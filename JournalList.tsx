...
export const JournalList:
  React.FC<JournalListProps> = ({
    ...
    /*
     * Thought Diff creation can become visible to the next Firestore read
     * a fraction of a second after the generation request returns.
     * Refresh once immediately and once shortly afterwards so the UI,
     * Year in Reflection, and Thought Diffs tab update without a browser refresh.
     */
    const refreshAfterThoughtDiff =
      async () => {
        await loadData();
