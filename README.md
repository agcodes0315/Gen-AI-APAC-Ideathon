...
[![Repository](https://img.shields.io/badge/GitHub-View%20Repository-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/agcodes0315/Gen-AI-APAC-Ideathon)
...
<img src="docs/images/sign-in-page.jpeg"
     alt="MirrorTrace Public Landing Page"
     width="100%"/>
...
<img src="docs/images/target-audience.jpeg"
...
<img src="docs/images/user-overview.jpeg"
     alt="MirrorTrace User Overview"
     width="100%"/>
...
<img src="docs/images/quick-actions.jpeg"
     alt="MirrorTrace Quick Actions"
     width="100%"/>
...
<img src="docs/images/reflective-space.jpeg"
...
<img src="docs/images/journal-history.jpeg"
...
<img src="docs/images/year-in-reflection.jpeg"
...
<img src="docs/images/memory-governance.jpeg"
...
<img src="docs/images/mirrorroom.jpeg"
...
<img src="docs/images/admin-dashboard.jpeg"
...
<img src="docs/images/admin-service-health.jpeg"
...
flowchart TD
    A[User]
    B[React + TypeScript Client]
    C[Firebase Authentication]
    D[Express + TypeScript Backend]
    E[Firebase Admin Token Verification]

    F[Journal APIs]
    G[Conversation APIs]
    H[Thought Snapshot APIs]
    I[Thought Diff + Provenance APIs]
    J[Perspective Watch APIs]
    K[MirrorRoom APIs]
    L[Support + Feedback APIs]
    M[Admin APIs]
...
flowchart TD
    ...
    B[Optional Gemini Brainstorm]
    C[Thought Snapshot Proposal]
    D{User Decision}
    E[Reject]
    F[Accept]
    G[Edit and Accept]
    H[Approved Reusable Memory]
    I{Related Approved Snapshot Exists?}
    J[Wait for Future Reflection]
    K[Thought Diff Evaluation]
    L[Thought Diff]
    M[Provenance]
    N[Optional Perspective Watch]
...
sequenceDiagram
    ...
    A->>API: Create room
    API->>DB: Store room and host membership
    API-->>A: Return invite code
    ...
    API->>DB: Store explicit contribution only
