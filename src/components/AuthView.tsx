...
function getAccentClasses(
  ...
  switch (
    ...
    case 'stone':
      return {
        icon:
          'bg-stone-400/15 text-stone-200',
        ...
        >
          ...
          <video
            ...
            style={{
              /*
               * No blur here.
               * Full-screen video blur is expensive during scrolling.
               */
              filter:
