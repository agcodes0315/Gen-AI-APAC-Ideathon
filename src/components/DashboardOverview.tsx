      ...
      <div className="space-y-8 animate-fade-in">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className="w-8 h-8 rounded-lg bg-stone-100 text-stone-600 group-hover:bg-amber-100 group-hover:text-amber-900 flex items-center justify-center transition-colors">
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className="w-8 h-8 rounded-lg bg-amber-50 text-amber-800 group-hover:bg-amber-100 group-hover:text-amber-900 flex items-center justify-center transition-colors">
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className="w-8 h-8 rounded-lg bg-amber-900/10 text-amber-900 group-hover:bg-amber-900 group-hover:text-amber-50 flex items-center justify-center transition-colors">
          ...
          {latestDiff ? (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-11 gap-3 sm:gap-4 items-center">
                <div className="md:col-span-5 bg-white border border-stone-200 rounded-xl p-4 space-y-2">
                  <div className="flex items-center justify-between">
                ...
                <div className="md:col-span-1 flex items-center justify-center py-1 md:py-0">
                  <div className="w-8 h-8 rounded-full bg-amber-100/80 text-amber-900 border border-amber-300/80 flex items-center justify-center">
                    <ArrowRight className="w-4 h-4 rotate-90 md:rotate-0" />
                  </div>
                </div>

                <div className="md:col-span-5 bg-amber-50/70 border border-amber-200/90 rounded-xl p-4 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-mono uppercase tracking-wider text-amber-950 font-bold">
                      Current Stance
                    </span>

                    <span className="px-2 py-0.5 rounded text-[10px] bg-amber-200/70 text-amber-950 font-semibold">
                      Later Reflection
                    </span>
                  </div>
              ...
              <div className="bg-white/80 border border-stone-200/90 rounded-xl p-4 space-y-2">
            ...
            <div
              ...
              className="bg-white border border-dashed border-stone-300 rounded-2xl p-8 text-center space-y-5"
            >
        ...
        {showHowItWorks && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-900/40 backdrop-blur-xs">
            <div className="bg-white rounded-2xl border border-stone-200 shadow-xl max-w-xl w-full max-h-[85vh] overflow-y-auto p-6 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-stone-200 shadow-xl max-w-lg w-full max-h-[85vh] overflow-y-auto p-6 space-y-5">
              ...
              {loadingProvenance ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="border border-amber-200 rounded-lg bg-amber-50/40 p-4 space-y-2">
                    <div className="flex items-center gap-2 text-xs font-semibold text-stone-900">
                      <FileText className="w-4 h-4" />
