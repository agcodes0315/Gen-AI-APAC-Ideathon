...
interface DashboardOverviewProps {
  ...
  loading: boolean;
  onNavigate: (
    tab: 'overview' | 'journal' | 'history' | 'memory' | 'support' | 'feedback',
    options?: DashboardNavigationOptions
  ) => void;
}

function AnimatedNumber(props: { value: number; loading: boolean }) {
  return (
    <motion.span
      key={props.loading ? 'loading' : props.value}
          ...
          <div className="mirrortrace-hero-content relative z-10 grid gap-8">
            <div>
              ...
              <h1 className="mt-5 max-w-3xl font-serif text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl mirrortrace-float-title">
                Your thinking,
                <span className="block text-amber-200">versioned.</span>
              </h1>
              ...
              <div className="mt-7 flex flex-wrap gap-3 mirrortrace-float-actions">
                <motion.button
                  ...
                  className="mirrortrace-primary-btn mt-hover-pop inline-flex items-center gap-2 rounded-full px-5 py-3 text-sm font-semibold"
                >
                ...
                <motion.button
                  ...
                  className="mirrortrace-secondary-btn mt-hover-pop inline-flex items-center gap-2 rounded-full px-5 py-3 text-sm font-semibold"
                >
          ...
          {[
            {
              ...
              icon: BookOpen,
              onClick: () =>
                onNavigate('history', { subTab: 'reflections' }),
            },
            {
              id: 'stat-snapshots',
              label: 'Approved Snapshots',
              detail: 'Only interpretations you approved',
              suffix: 'structured',
            ...
            },
            {
              id: 'stat-diffs',
              label: 'Thought Diffs',
              detail: 'Evidence-backed perspective changes',
              suffix: 'comparisons',
              value: thoughtDiffsCount,
              icon: GitCompare,
              onClick: () => onNavigate('history', { subTab: 'diffs' }),
            },
          ].map((card) => {
            ...
            return (
              <motion.button
                ...
                className="mirrortrace-stat-card mt-glass mt-glass-warm mt-hover-pop group rounded-[26px] p-5 text-left"
              >
        ...
        >
          ...
          {latestDiff ? (
            <motion.div
              ...
              className="mt-glass mt-glass-cool mt-hover-pop cursor-pointer rounded-[28px] p-5 sm:p-6"
            >
              ...
              <div className="mt-5 grid grid-cols-1 items-center gap-4 md:grid-cols-11">
                <div className="rounded-2xl bg-white/5 p-4 md:col-span-5">
              ...
              <div className="mt-4 grid gap-3 lg:grid-cols-2">
                <div className="rounded-2xl border border-white/10 p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <strong className="text-xs">What Changed</strong>
                  </div>
              ...
              <div className="mt-4 flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
                ...
                <button
                  ...
                  className="mt-hover-pop inline-flex items-center gap-1.5 rounded-xl border border-amber-300/40 bg-amber-500/10 px-4 py-2.5 text-xs font-semibold text-amber-100"
                >
            ...
            <div className="mt-glass mt-glass-plain rounded-[28px] border-dashed p-8 text-center">
              <div className="mx-auto grid h-12 w-12 place-items-center rounded-2xl border border-amber-300/30 bg-amber-500/10 text-amber-200">
              ...
              <div className="mt-5 flex flex-wrap items-center justify-center gap-3">
                <button
                  type="button"
                  onClick={() => onNavigate('journal')}
                  className="mt-hover-pop inline-flex items-center gap-2 rounded-xl bg-amber-700 px-4 py-2 text-sm font-semibold text-amber-50"
                >
                  <PenLine className="h-4 w-4" />
                  Write a Reflection
                </button>
                ...
                <button
                  ...
                  className="mt-hover-pop inline-flex items-center gap-2 rounded-xl bg-white/10 px-4 py-2 text-sm font-semibold"
                >
            ...
            {[
              {
                ...
                body: 'Compose a new journal entry or brainstorm with the AI companion.',
                action: 'Open Reflect & Chat',
                icon: PenLine,
                onClick: () => onNavigate('journal'),
              },
              {
                title: 'Private Session',
                body: 'Reflect freely without saving to Firestore history or generating AI memory.',
                action: 'Start Private Session',
                icon: EyeOff,
                onClick: () =>
                  onNavigate('journal', { privateSession: true }),
              },
              {
                title: 'Journal History',
                body: 'Browse your private timeline, approved snapshots, and full comparison history.',
              ...
              return (
                <motion.button
                  ...
                  className="mirrortrace-action-card mt-glass mt-glass-warm mt-hover-pop group rounded-[26px] p-5 text-left"
                >
                  <div className="grid h-10 w-10 place-items-center rounded-xl bg-amber-500/15 text-amber-200">
              ...
              <div className="flex items-center justify-between border-b border-stone-200 pb-3">
                <div>
                  ...
                  <p className="text-xs text-stone-600">
                    Version control for your thinking in three
